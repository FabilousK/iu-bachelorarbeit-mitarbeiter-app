...
if (!defined('K_PATH_IMAGES')) {
	$tcpdf_images_dirs = array(str_replace("/data/php/tcpdf","/data/",dirname(__FILE__)).'img/', K_PATH_MAIN.'images/', '/usr/share/doc/php-tcpdf/examples/images/', '/usr/share/doc/tcpdf/examples/images/', '/usr/share/doc/php/tcpdf/examples/images/', '/var/www/tcpdf/images/', '/var/www/html/tcpdf/images/', '/usr/local/apache2/htdocs/tcpdf/images/', K_PATH_MAIN);
...
if (!defined('PDF_HEADER_LOGO')) {
	$tcpdf_header_logo = '';
	if (@file_exists(K_PATH_IMAGES.'Logo-mit-claim-SB_600dpi-1024x321.jpg')) {
		$tcpdf_header_logo = 'Logo-mit-claim-SB_600dpi-1024x321.jpg';
	}
